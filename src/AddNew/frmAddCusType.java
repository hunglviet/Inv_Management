 ...
 * @author lvhung
 */
public class frmAddCusType extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmAddCusType.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
