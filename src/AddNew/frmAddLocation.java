 ...
 * @author lvhung
 */
public class frmAddLocation extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmAddLocation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
