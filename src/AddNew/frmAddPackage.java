 ...
 * @author lvhung
 */
public class frmAddPackage extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmAddPackage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
