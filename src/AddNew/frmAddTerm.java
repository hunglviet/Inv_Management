 ...
 * @author lvhung
 */
public class frmAddTerm extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmAddTerm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
